...
function extractSiteName(input) {
    ...
    input = input.split('/').slice(2).join('/');
    ...
    if (parts.length - tldLength - 1 >= 0) {
        mainDomain = parts[parts.length - tldLength - 1];
    }
